...
function  task_8 (value){
    try {
        ...
        const resultTextErrValid = 'К сожалению, ответ не верный. Помни, что JavaScript может неявно преобразовывать типы данных, что, в свою очередь, может привести к неожиданному результату.'
